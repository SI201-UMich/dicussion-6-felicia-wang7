...
class PollReader():
    ...
    def likely_voter_polling_average(self):
        ...
        return (harris_sum / counter, trump_sum / counter) if counter > 0 else (0.0, 0.0)
    ...
    def polling_history_change(self):
        ...
        return (early_harris - late_harris), (early_trump - late_trump)
